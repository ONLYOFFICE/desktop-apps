...
nn_NO.extDOC =Word 97-2003-dokument
...
nn_NO.extDOCX =Office Open XML-dokument
...
ru.extDOCXF =Шаблон формы ONLYOFFICE Document
...
ro.extDOCXF =Șablon Formă ONLYOFFICE Document
...
gl.extDOCXF =Documento ONLYOFFICE Modelo de Formulario
...
nn_NO.extXLSX =Office Open XML-regneark
...
nn_NO.extPPT =PowerPoint 97-2003-presentasjon
...
nn_NO.extPPTX =Office Open XML-presentasjon
...
nn_NO.extCSV =Kommadelte verdier
...
nn_NO.extPDF =Portable Document
...
nn_NO.extDJVU =Digitalt dokument
...
nn_NO.extOFORM =ONLYOFFICE utfyllbart elektronisk skjema
...
//  AudioExts[12] := 'TXT';
  ...
  ExtensionRegistryInfo[16] := prefix + 'Docxf:'       + ExpandConstant('{cm:extDOCXF}')            + ':' + '12';
  ExtensionRegistryInfo[17] := prefix + 'Oform:'       + ExpandConstant('{cm:extOFORM}')            + ':' + '13';
end;

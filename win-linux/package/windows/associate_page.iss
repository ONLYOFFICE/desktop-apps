...
hy-AM.AssociateDescription =Կապակցել office փաստաթղթային ֆայլերը {#ASSC_APP_NAME}-ի հետ
hr.AssociateDescription =Povežite vrste datoteka uredskih dokumenata s{#ASSC_APP_NAME}
da.AssociateDescription =Tilknyt office dokumentfiltyper med {#ASSC_APP_NAVN}
...
ga-IE.AssociateDescription =Cineálacha comhaid doiciméad oifige comhlachaithe le {#ASSC_APP_NAME}
...
nn-NO.AssociateDescription =Tilknytt filtyper for Office-dokumenter til {#ASSC_APP_NAME}}
...
hy-AM.AssociateCaption =Ֆայլերի կապակցումներ
...
hy-AM.AssociateAll =Կապակցել բոլորը
...
hy-AM.AssociateSel =Կապակցել ընտրվածները
...
hy-AM.extMSWord =Microsoft Word փաստաթուղթ
...
ga-IE.extMSWord =Doiciméad Microsoft Word
...
nn-NO.extMSWord =Microsoft Word-dokument
...
hy-AM.extMSExcel =Microsoft Excel Workbook
...
ga-IE.extMSExcel =Leabhar oibre Microsoft Excel
...
nn-NO.extMSExcel =Microsoft Excel-arbeidsbok
...
hy-AM.extMSPresentation =Microsoft PowerPoint ներկայացում
...
ga-IE.extMSPresentation =Láithreoireacht Microsoft PowerPoint
...
nn-NO.extMSPresentation =Microsoft PowerPoint-presentasjon
...
hy-AM.extMSSlideshow =Microsoft PowerPoint սլայդշոու
...
ga-IE.extMSSlideshow =Taispeántas sleamhnán Microsoft PowerPoint
...
nn-NO.extMSSlideshow =Microsoft PowerPoint-lysbildefremvisning
...
hy-AM.extODT =OpenDocument տեսքստային փաստաթուղթ
...
hy-AM.extODS =OpenDocument աղյուսակ
...
hy-AM.extODP =OpenDocument ներկայացնում
...
hy-AM.defprogAppDescription=Աշխատասեղանի անվճար office փաթեթ՝ փաստաթղթերի խմբագրման և գործակցության համար
...
ga-IE.defprogAppDescription=Sraith oifige deisce saor in aisce le haghaidh eagarthóireacht doiciméad agus
...
nn-NO.defprogAppDescription=Gratis office-pakke til PC for dokumentredigering og samarbeid med andre
...
hy-AM.warnWin10FileAssociationDesc=Ֆայլերը հավելվածի հետ կապակցելու համար՝ բացեք հետևյալ պատուհանը տեղադրման ավարտից հետո՝
...
ga-IE.warnWin10FileAssociationDesc=Chun na comhaid a cheangal leis an bhfeidhmchlár, oscail an fhuinneog seo a leanas tar éis don tsuiteáil a bheith críochnaithe:
...
nn-NO.warnWin10FileAssociationDesc=For å tilknytte filene til programmet, åpne det påfølgende vinduet etter at installasjonen er fullført:
...
hy-AM.warnWin10FileAssociationPath=Կարգավորումներ > Հավելվածներ > Լռելյայն հավելվածներ
...
ga-IE.warnWin10FileAssociationPath=Socruithe > Feidhmchláir > Feidhmchláir réamhshocraithe
...
nn-NO.warnWin10FileAssociationPath=Innstillinger > Apper > Standard-apper
...
hy-AM.runOpenDefaultApps=Բացել լռելյայն հավելվածները

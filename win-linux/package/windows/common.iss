...
Source: data\vcredist\vcredist_2019_{#sWinArch}.exe; DestDir: {app}; Flags: deleteafterinstall; \
  AfterInstall: installVCRedist(ExpandConstant('{app}\vcredist_2019_{#sWinArch}.exe'), ExpandConstant('{cm:InstallAdditionalComponents}')); \

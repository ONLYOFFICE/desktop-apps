...
Name: hy-AM; MessagesFile: compiler:Languages\Armenian.isl;     LicenseFile: {#sBrandingFolder}\common\package\license\{#LIC_FILE}.rtf;
...
Name: ga-IE; MessagesFile: compiler:Default.isl;              LicenseFile: {#sBrandingFolder}\common\package\license\{#LIC_FILE}.rtf;
...
Name: nn-NO; MessagesFile: compiler:Languages\Norwegian.isl;     LicenseFile: {#sBrandingFolder}\common\package\license\{#LIC_FILE}.rtf;
...
zh_CN.Launch =启动%1
hy-AM.Launch =Գործարկում %1
hr.Launch =Pokretanje %1
da.Launch =Start %1
hi.Launch =लॉन्च %1
hu.Launch =%1 elindítása
ga-IE.Launch =Lainseáil %1
ja.Launch ==%1 を起動
ko.Launch ==%1 시작
lv.Launch =Sākt %1
nn-NO.Launch =Kjør %1
...
hy-AM.CreateDesktopIcon =Ստեղծել %1 &աշխատասեղանի պատկերակ
...
hy-AM.InstallAdditionalComponents =Համակարգչի լրացուցիչ բաղադրիչների տեղադրում։ Խնդրում ենք սպասել․․․
...
ga-IE.InstallAdditionalComponents =Comhpháirteanna córais breise a shuiteáil. Fán le do thoil...
...
nn-NO.InstallAdditionalComponents =Installerer flere systemkomponenter. Vennligst vent...
...
hy-AM.WarningWrongArchitecture =Դուք պատրաստվում եք տեղադրել հավելվածի %1-բիթանոց տարբերակը՝ տեղադրված %2-բիթանոց տարբերակի փոխարեն։ Խնդրում ենք նախ ապատեղադրել նախորդ տարբերակը կամ բեռնել ճիշտ տարբերակը՝ տեղադրման համար։
...
ga-IE.WarningWrongArchitecture =Tá tú ag iarraidh a shuiteáil an leagan iarratais 1-giotán ar fud an leagan 2- giotán shuiteáil. Díshuiteáil an leagan roimhe seo ar dtús nó íoslódáil an leagan ceart le haghaidh suiteála.
...
nn-NO.WarningWrongArchitecture =Du forsøker å installere %1-bits-versjonen av programmet over %2-bits-versjonen som er installert. Avinstaller forrige versjon først, eller last ned riktig versjon for installering.
...
hy-AM.UpdateAppRunning=Կարգավորումը հայտնաբերել է, որ այս պահին աշխատում է %1-ը։ %n%nԱյն ավտոմատ կփակվի։ Խնդրում ենք սեղմել ԼԱՎ՝ շարունակելու համար կամ Չեղարկել՝ դուրս գալու համար։
...
ga-IE.UpdateAppRunning=Tá sé aimsithe ag an socrú go bhfuil %1 ag rith faoi láthair. Dúnfar é go huathoibríoch. Cliceáil OK chun leanúint ar aghaidh, nó Cealaigh chun imeacht.
...
nn-NO.UpdateAppRunning=Installasjonen har oppdaget at %1 kjører for øyeblikket.%n%nDen vil lukkes automatisk. Klikk OK for å fortsette, eller Avbryt for å avslutte.
...
hy-AM.WarningClearAppData =Ցանկանու՞մ եք ջնջել օգտագործողի կարգավորումները և հավելվածի պահպանված տվյալները։
...
ga-IE.WarningClearAppData =Ar mhaith leat na socruithe úsáideora agus sonraí taiscthe feidhmchláir a ghlanadh?
...
nn-NO.WarningClearAppData =Vil du slette brukerinnstillinger og bufrede data for programmet?
...
;hy-AM.AssociateDescription =Կապակցել office փաստաթղթային ֆայլերը 1%-ի հետ
...
;ga-IE.AssociateDescription =Cineálacha comhaid doiciméad oifige comhlachaithe le 1%
...
;nn-NO.AssociateDescription =Tilknytt filtyper for Office-dokumenter til %1

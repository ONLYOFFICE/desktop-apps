...
Type=Application
GenericName=M4_COMPANY_NAME M4_PRODUCT_NAME
Comment=Edit office documents
Exec=/usr/bin/M4_PACKAGE_NAME %F
Terminal=false
...
Exec=/usr/bin/M4_PACKAGE_NAME --new:word
...
Exec=/usr/bin/M4_PACKAGE_NAME --new:cell
...
Exec=/usr/bin/M4_PACKAGE_NAME --new:slide

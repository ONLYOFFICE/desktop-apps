...
cp -r ../../../common/opt/ivolga "$RPM_BUILD_ROOT/opt"
...
%files
%attr(-, root, root) /opt/ivolga/desktopeditors/*
...
for icon in "/opt/ivolga/desktopeditors/asc-de-"*.png; do
  size="${icon##*/asc-de-}"
...
mkdir -p /var/lib/ivolga/desktopeditors
chmod -R 777 /var/lib/ivolga/desktopeditors

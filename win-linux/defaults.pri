...
ADD_DEPENDENCY(PdfReader, PdfWriter, DjVuFile, XpsFile, HtmlRenderer, UnicodeConverter, hunspell, ooxmlsignature, kernel, network, graphics, videoplayer, ascdocumentscore, qtascdocumentscore)

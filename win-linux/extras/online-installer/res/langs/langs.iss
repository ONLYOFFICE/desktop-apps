...
en.LABEL_INSTALL_COMPL =%1 Desktop Editors has been successfully installed on your computer.\nTo run the application after closing this installer, select the check box.
en_GB.LABEL_INSTALL_COMPL =%1 Desktop Editors has been successfully installed on your computer.\nTo run the application after closing this installer, select the check box.
ru.LABEL_INSTALL_COMPL =%1 Desktop Editors успешно установлен на вашем компьютере.\nЧтобы запустить приложение после закрытия этого установщика, установите флажок.
de.LABEL_INSTALL_COMPL =%1 Desktop Editoren wurde erfolgreich auf Ihrem Computer installiert.\nUm die App nach dem Schließen dieses Installationsprogramms auszuführen, aktivieren Sie das Kontrollkästchen.
fr.LABEL_INSTALL_COMPL =%1 Desktop Editors a été installé avec succès sur votre ordinateur.\nPour exécuter l'application après avoir fermé ce programme d'installation, cochez la case.
es.LABEL_INSTALL_COMPL =%1 Desktop Editors se ha instalado correctamente en su ordenador.\nPara ejecutar la aplicación después de cerrar este instalador, seleccione la casilla de verificación.
it.LABEL_INSTALL_COMPL =%1 Desktop Editors è stato installato con successo sul tuo computer. \nPer avviare l'applicazione dopo aver chiuso questo programma di installazione, seleziona la casella di controllo.
ja.LABEL_INSTALL_COMPL =%1デスクトップエディタがコンピュータにインストールされます。\n続行する前に、他のアプリケーションをすべて終了することをお勧めします。
zh_CN.LABEL_INSTALL_COMPL =此操作将在您的计算机上安装 %1 桌面编辑器。\n建议您在继续之前关闭所有其他应用程序。
ro.LABEL_INSTALL_COMPL =Editor de birou %1 a fost instalat cu succes pe calculatorul dvs.\nPentru a porni aplicația după închiderea asistentului de instalare, faceți clic pe caseta de selectare.
hy.LABEL_INSTALL_COMPL =%1 Desktop Editors-ը հաջողությամբ տեղադրվել է ձեր համակարգչում:\nԱյս տեղադրիչը փակելուց հետո հավելվածը գործարկելու համար ընտրեք վանդակը:
PT_BR.LABEL_INSTALL_COMPL =%1 Desktop Editors foi instalado com êxito em seu computador.\nPara executar o aplicativo após fechar esse instalador, marque a caixa de seleção.
sr_Latn_RS.LABEL_INSTALL_COMPL =%1 Desktop Editors je uspešno instaliran na vašem računaru.\nDa biste pokrenuli aplikaciju nakon zatvaranja ovog instalacionog programa, označite polje za potvrdu.
sr_Cyrl_RS.LABEL_INSTALL_COMPL =%1 Desktop Editors је успешно инсталиран на вашем рачунару.\nДа бисте покренули апликацију након затварања овог инсталационог програма, означите поље за потврду.
...
tr.LABEL_INSTALL_COMPL =%1 Desktop Editors bilgisayarınıza başarıyla yüklendi.\nBu yükleyiciyi kapattıktan sonra uygulamayı çalıştırmak için onay kutusuna tıklayın.
uk.LABEL_INSTALL_COMPL =Настільні редактори %1 успішно інстальовано на ваш комп'ютер.\nЩоб запустити застосунок після закриття цього інсталятора, установіть прапорець.
pl.LABEL_INSTALL_COMPL =Pomyślnie zainstalowano %1 Desktop Editors na Twoim komputerze.\nAby uruchomić aplikację po zamknięciu tego instalatora, zaznacz pole wyboru.
sk.LABEL_INSTALL_COMPL =%1 Desktop Editors bol úspešne nainštalovaný na váš počítač.\nAk chcete spustiť aplikáciu po zatvorení inštalácie, označte zaškrtávacie políčko.
vi.LABEL_INSTALL_COMPL =%1 Desktop Editors đã được cài đặt thành công trên máy tính của bạn.\nĐể chạy ứng dụng sau khi đóng trình cài đặt này, hãy nhấp chọn vào ô.
he.LABEL_INSTALL_COMPL =%1 הותקן בהצלחה במחשב שלךDesktop Editors.\nכדי להפעיל את היישום לאחר סגירת מתקין זה, בחר בתיבת הסימון.
lv.LABEL_INSTALL_COMPL =%1 Desktop Editors ir veiksmīgi instalēta jūsu datorā.\nLai palaistu programmu pēc instalatora aizvēršanas, atzīmējiet izvēles rūtiņu.
sq.LABEL_INSTALL_COMPL =%1 Desktop Editors është instaluar me sukses në kompjuterin tuaj.\nPër të ekzekutuar aplikacionin pas mbylljes së këtir instaluesi, zgjidhni kutinë e kontrollit.
id.LABEL_INSTALL_COMPL =%1 Desktop Editors berhasil terpasang ke komputer Anda.\nSetelah menutup installer, centang kotak untuk menjalankan aplikasi.
sv.LABEL_INSTALL_COMPL =%1 Desktop Editors har installerats framgångsrikt på din dator.\nOm du vill köra programmet efter att du har stängt det här installationsprogrammet markerar du kryssrutan.

...
zh_CN.LABEL_TITLE_TEXT =准备安装
ro.LABEL_TITLE_TEXT =Pregătire pentru instalare
ar_SA.LABEL_TITLE_TEXT =التحضير للتثبيت
...
pt_PT.LABEL_TITLE_TEXT =Preparando para instalação
...
sr_Latn_RS.LABEL_TITLE_TEXT =Priprema za instalaciju
...
sr_Cyrl_RS.LABEL_TITLE_TEXT =Припрема за инсталацију
...
pt_PT.LABEL_MESSAGE_TEXT_ERR1 =Ocorreu um erro durante a inicialização.\nTente reiniciar o aplicativo mais tarde.
...
sr_Latn_RS.LABEL_MESSAGE_TEXT_ERR1 =Pojavila se greška prilikom inicijalizacije.\nMolimo pokušajte da restartujete aplikaciju kasnije.
...
sr_Cyrl_RS.LABEL_MESSAGE_TEXT_ERR1 =Појавила се грешка приликом иницијализације.\nМолимо покушајте да рестартујете апликацију касније.
...
zh_CN.LABEL_MESSAGE_TEXT_ERR2 =软件包下载失败：内存不足！\n请稍后尝试重新启动应用程序。
ro.LABEL_MESSAGE_TEXT_ERR2 =Descărcarea pachetului eșuată: Memoria este insuficientă!\nÎncercaţi să reporniți aplicația mai târziu.
ar_SA.LABEL_MESSAGE_TEXT_ERR2 =فشل تنزيل الحزمة: لا توجد ذاكرة كافية!\nالرجاء محاولة إعادة تشغيل التطبيق لاحقا.
...
pt_PT.LABEL_MESSAGE_TEXT_ERR2 =Falha no download do pacote: memória insuficiente!\nTente reiniciar o aplicativo mais tarde.
...
sr_Latn_RS.LABEL_MESSAGE_TEXT_ERR2 =Preuzimanje paketa neuspešno: Nedovoljno memorije!\nMolimo pokušajte da restartujete aplikaciju kasnije.
...
sr_Cyrl_RS.LABEL_MESSAGE_TEXT_ERR2 =Преузимање пакета неуспешно: Недовољно меморије!\nМолимо покушајте да рестартујете апликацију касније.
...
zh_CN.LABEL_MESSAGE_TEXT_ERR3 =软件包下载失败：服务器连接错误！\n请稍后尝试重新启动应用程序。
ro.LABEL_MESSAGE_TEXT_ERR3 =Descărcarea pachetului eșuată: Eroare de conectare la server!\nÎncercaţi să reporniți aplicația mai târziu.
ar_SA.LABEL_MESSAGE_TEXT_ERR3 =فشل تنزيل الحزمة: خطأ في اتصال الخادم!\nالرجاء محاولة إعادة تشغيل التطبيق لاحقا.
...
pt_PT.LABEL_MESSAGE_TEXT_ERR3 =Falha no download do pacote: erro de conexão do servidor!\nTente reiniciar o aplicativo mais tarde.
...
sr_Latn_RS.LABEL_MESSAGE_TEXT_ERR3 =Preuzimanje paketa neuspešno: Greška u vezi sa povezivanjem na server!\nMolimo pokušajte da restartujete aplikaciju kasnije.
...
sr_Cyrl_RS.LABEL_MESSAGE_TEXT_ERR3 =Преузимање пакета неуспешно: Грешка у вези са повезивањем на сервер!\nМолимо покушајте да рестартујете апликацију касније.
...
zh_CN.LABEL_MESSAGE_TEXT_ERR4 =软件包下载失败：网络错误！\n请稍后尝试重新启动应用程序。
ro.LABEL_MESSAGE_TEXT_ERR4 =Descărcarea pachetului eșuată: Eroare de rețea!\nÎncercaţi să reporniți aplicația mai târziu.
ar_SA.LABEL_MESSAGE_TEXT_ERR4 =فشل تنزيل الحزمة: خطأ في الشبكة!\nالرجاء محاولة إعادة تشغيل التطبيق لاحقا.
...
pt_PT.LABEL_MESSAGE_TEXT_ERR4 =Falha no download do pacote: erro de rede!\nTente reiniciar o aplicativo mais tarde.
...
sr_Latn_RS.LABEL_MESSAGE_TEXT_ERR4 =Preuzimanje paketa neuspešno: Greška u mreži!\nMolimo pokušajte da restartujete aplikaciju kasnije.
...
sr_Cyrl_RS.LABEL_MESSAGE_TEXT_ERR4 =Преузимање пакета неуспешно: Грешка у мрежи!\nМолимо покушајте да рестартујете апликацију касније.
...
zh_CN.LABEL_MESSAGE_TEXT_ERR6 =初始化期间发生错误：未设置 URL。
ro.LABEL_MESSAGE_TEXT_ERR6 =A intervenit o eroare în timpul inițializării: Adresa URL nu este setată.
ar_SA.LABEL_MESSAGE_TEXT_ERR6 =حدث خطأ أثناء التهيئة: لم يتم تعيين عنوان URL.
...
pt_PT.LABEL_MESSAGE_TEXT_ERR6 =Ocorreu um erro durante a inicialização: URL não definido.
...
sr_Latn_RS.LABEL_MESSAGE_TEXT_ERR6 =Došlo je do greške prilikom inicijalizacije: URL nike postavljen.
...
sr_Cyrl_RS.LABEL_MESSAGE_TEXT_ERR6 =Дошло је до грешке приликом иницијализације: URL нике постављен.
...
zh_CN.LABEL_MESSAGE_TEXT_ERR7 =初始化期间发生错误：未指定文件名。
ro.LABEL_MESSAGE_TEXT_ERR7 =A intervenit o eroare în timpul inițializării: Numele fișierului nu este indicat.
ar_SA.LABEL_MESSAGE_TEXT_ERR7 =حدث خطأ أثناء التهيئة: لم يتم تحديد اسم الملف.
...
pt_PT.LABEL_MESSAGE_TEXT_ERR7 =Ocorreu um erro durante a inicialização: Nome do arquivo não especificado.
...
sr_Latn_RS.LABEL_MESSAGE_TEXT_ERR7 =Došlo je do greške prilikom inicijalizacije: Ime datoteke nije navedeno.
...
sr_Cyrl_RS.LABEL_MESSAGE_TEXT_ERR7 =Дошло је до грешке приликом иницијализације: име датотеке није наведено.

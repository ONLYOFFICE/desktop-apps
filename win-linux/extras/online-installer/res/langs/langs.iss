...
fr.LABEL_WARN_CLOSE =Ceci installera ONLYOFFICE Desktop Editors sur votre ordinateur.\nIl est recommandé de fermer toutes les autres applications avant de continuer.
...
it.LABEL_WARN_CLOSE =Questo installerà ONLYOFFICE Desktop Editors sul tuo computer.\nSi consiglia di chiudere tutte le altre applicazioni prima di procedere.

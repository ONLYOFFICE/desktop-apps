...
## Desktop apps
The frontend for [ONLYOFFICE Desktop Editors][2]. Builds the program interface and allows the user create, edit, save and export documents, spreadsheets, presentations, PDFs, and PDF forms documents using the common interface of a document editor.

...
- (id)initTextCell:(NSString *)string {
    ...
    if (self) {
        self.image = [NSImage imageNamed:@"icon_tabs_exit_inactive"];
    }
...
- (void)mouseEntered:(NSEvent *)theEvent {
    ...
    self.image = [NSImage imageNamed:@"icon_tabs_exit_hover"];
}
...
- (void)mouseDown:(NSEvent *)theEvent {
    ...
    self.image = [NSImage imageNamed:@"icon_tabs_exit_click"];
}

...
- (void)initialize {   
    ...
    [self.close setFrame:CGRectMake(CGRectGetWidth(self.frame) - kASTabViewCloseButtonSize * 1.5, kASTabViewCloseButtonSize / 1.5, kASTabViewCloseButtonSize, kASTabViewCloseButtonSize)];
}

        ...
        var _html = `<div class="action-panel ${args.action}">
                      <div class="flex-center">
                         <section class="center-box">
                              <h3 class="empty-title" l10n style="margin:0 0 60px;">${_lang.welWelcome}</h3>
                              <div class='carousel'>
                                <figure class='carousel__slidebox'>                                
                                    <div class='carousel__slide active'>
                                        <p class='carousel__slide__text title' l10n>${_lang.welSlide1Title}</p>
                                        <p class='carousel__slide__text descr' l10n>${_lang.welDescr}</p>

l10n.hi = {
    ...
    settSpellcheckDetection: 'वर्तनी की भाषा का पता लगाना',
    settOptDisabled: 'अक्षम',
    settOptEnabled: 'सक्षम',
    aboutChangelog: 'लॉगबदलें',
    updateNoUpdates: 'ऐप अद्यतित है',
    updateAvialable: '$1 संस्करण उपलब्ध है। डाउनलोड करने के लिए क्लिक करें।',
    settOptThemeSystem: 'सिस्टम के समान है',
    settOptThemeAddLocal: 'लोकल (स्थानीय) थीम जोड़ें',
    settOptThemeContrastDark: 'कॉन्ट्रास्ट डार्क',
    settAUpdateMode: 'स्वतः अद्यतन मोड',
    settOptAUpdateSilent: 'ऑटो',
    settOptAUpdateAsk: 'सूचित करना',
    settOptAUpdateDisabled: 'नियमावली',
    updateDownloadFinished: 'डाउनलोड पूरा हुआ। इंस्टॉल करने के लिए क्लिक करें।',
    updateDownloadCanceled: 'डाउनलोड रद्द हुआ',
    updateDownloadProgress: '$1% डाउनलोड हो रहा है। रोकने के लिए क्लिक करें।',
    settOptDescDisabled: "स्वतः जाँच अपडेट अक्षम होंगे",
    settOptDescAUpdateSilent: "अपडेट डाउनलोड करें और इंस्टॉल करने के पहले पूछें",
    ...
    settUseAI: 'AI सुविधाओं का उपयोग करें',
}
